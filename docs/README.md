...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-26 22:12:29 UTC<br>状态：成功</p>
</section>
...
<p>今日速读5篇，0篇精读，聚焦3D高斯压缩、混合神经视频解码与网格纹理压缩三大方向。最值得关注的是最高分7.0的《Towards Practical Compression of 3D Gaussian Splatting》，以及《Beyond UV Mapping》提出的表面对齐纹理场新思路。普通读者可先从3D高斯压缩入手，理解如何在保持渲染质量的同时大幅减小模型体积。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Towards Practical Compression of 3D Gaussian Splatting">Towards Practical Compression of 3D Gaussian Splatting</span></li><li><span class="dpr-home-dashboard-paper-title" title="Resolution-Flexible Decoding for Hybrid Neural Video Representations">Resolution-Flexible Decoding for Hybrid Neural Video Representations</span></li><li><span class="dpr-home-dashboard-paper-title" title="Beyond UV Mapping: Mesh Texture Compression via Surface-Aligned Texture Fields">Beyond UV Mapping: Mesh Texture Compression via Surface-Aligned Texture Fields</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">compress <strong>3</strong></span><span class="dpr-home-dashboard-tag">neural-arch <strong>2</strong></span></div>
</section>
</div>
